...
def make_video_with_class(labels, class_names, output_path, fps=50):
    frame_list = glob.glob("{}/{}/att/*.png".format(args.out, args.video_name))
    ...
    out = cv2.VideoWriter(output_path, fourcc, fps, (width, height+50))
